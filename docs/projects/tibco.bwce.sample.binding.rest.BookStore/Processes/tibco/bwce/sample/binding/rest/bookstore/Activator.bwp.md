...
|insert\_into\_books| | | |
|ANOTHER\_CHANGE-input| | | |

## Activities: {#Activities}

### Name: ***ANOTHER\_CHANGE*** {#ANOTHER_CHANGE}
...
-   Input Variable: *ANOTHER\_CHANGE-input*
-   *Input bindings:*
    -   Mapping table
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://www.tibco.com/pe/WriteToLogActivitySchema" version="2.0"><xsl:template name="ANOTHER_CHANGE-input" match="/"><tns:ActivityInput><message><xsl:value-of select="&quot;&quot;"/></message></tns:ActivityInput></xsl:template></xsl:stylesheet>
        ```
